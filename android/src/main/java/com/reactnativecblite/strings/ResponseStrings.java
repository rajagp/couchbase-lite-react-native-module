package com.reactnativecblite.strings;
...
public class ResponseStrings {
    ...
    public static String DBExists="Database already exists";
    ...
    public static String invalidArgs="Invalid Arguments Passed";
    public static String invalidargsDCData="Invalid Arguments : Document data is not in proper JSON format";
    public static String NoArgs="No Arguments Passed";
    public static String Docnotfound="Document not found";
